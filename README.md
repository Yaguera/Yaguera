...
<p align="center">Sou um desenvolvedor <strong>Full-Stack</strong> em formação, apaixonado por criar experiências digitais cativantes e funcionais. Procuro iniciar minha carreira profissional, atualmente estou terminando o curso de <strong>Analise e Desenvolvimento de Sistemas na UNIFOR</strong>, e cursando a formação <strong>Full Stack Python na EBAC</strong> - Escola Britânica de Artes Criativas e Tecnologia. Possuo conhecimento em Next.js, React e node.js além de noções em Docker e ORMs como o Prisma. </p>&nbsp;
